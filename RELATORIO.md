...
| *(atual)* | **Explorar por região (SW v17, 33 testes):** seletor **🌍 Explorar por região** no mapa com 18 destinos mundiais (Rio, Buenos Aires, NY, Paris, Tóquio, Sydney…); ao escolher, o mapa voa para a região, ativa modo simulação ali e carrega o feed daquela área. Validado via CDP. |
